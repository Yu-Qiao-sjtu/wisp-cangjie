#!/usr/bin/env python
"""diff_sources.py — 两个版本的块清单 → change-set（纯确定性）。
...
near_duplicate / correction / contradiction 的语义定性不在本脚本伪造——由 Agent
按 methodology 合并规则复核后回填 change-set。

用法: python scripts/diff_sources.py <old-chunks.jsonl> <new-chunks.jsonl> --out <change-set.json> [--pack <slug>]
"""
...
from distill_common import dump_json  # noqa: E402
