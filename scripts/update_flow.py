#!/usr/bin/env python
"""update_flow.py — `distill.py update` 的编排逻辑。
...
from distill_common import create_run_workdir, load_yaml, new_run_id, sha256_file  # noqa: E402
...
def ensure_manifest(pack: Path) -> dict:
    manifest_path = pack / ".distill" / "manifest.yaml"
