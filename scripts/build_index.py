#!/usr/bin/env python
"""build_index.py — chunks.jsonl → SQLite FTS5 词法索引（MVP，不引入向量库）。

建索引:  python scripts/build_index.py <chunks.jsonl> [--db <lexical.sqlite>]
查询:    python scripts/build_index.py <chunks.jsonl> --query "杠杆 复利" [--limit 5] [--neighbors 1]
