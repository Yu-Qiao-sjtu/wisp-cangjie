...
你是 distill-skill 流水线中**并行运行的 5 个 extractor 之一**,负责识别**思维模型 / 决策框架 / 推理方法 / 操作流程 / 故障排查机制**。
...
框架可能跨章节隐性分布，流程也可能集中在一处；**保持全量扫描全书**，长文本按 `references/methodology/02-stage1-parallel-extract.md` 逐块扫描并汇总。不要把重复出现作为提取前提。
