#!/usr/bin/env python
"""run_output_evals.py — 输出评测的确定性环节。
...
用法:
  python scripts/run_output_evals.py prepare <suite.json> --out <dir> [--variants old_skill,new_skill,without_skill]
  python scripts/run_output_evals.py score   <suite.json> --outputs <dir> --mapping <mapping.json> --out <report.md>
"""
