#!/usr/bin/env python
"""repair_flow.py — `distill.py repair` 的编排逻辑。

repair 是可回滚事务。CLI 做确定性部分：校验失败案例 → 快照 → 生成诊断任务。
...
from distill_common import create_run_workdir, load_yaml, new_run_id, snapshot_dir  # noqa: E402
